...
export const SplitAnalyzerPanel: React.FC<SplitAnalyzerPanelProps> = ({ results, isLoading, onClose, onJumpToLine }) => {
                ...
                <div className="flex items-center gap-2">
                    ...
                    {isLoading ? (
                        <div className="flex items-center gap-2 ml-3">
                            ...
                            <span className="text-[10px] text-blue-400 font-bold animate-pulse uppercase tracking-wider">Analyzing logs...</span>
                        </div>
                    ) : (
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar relative min-h-0 bg-slate-950/20">
                {isLoading ? (
                    <div className="flex flex-col items-center justify-center p-8 h-full text-center">
                        <RefreshCw className="w-10 h-10 text-blue-500/20 animate-spin mb-3" />
                        <p className="text-slate-400 font-medium text-sm animate-pulse">Comparing log streams...</p>
                        <p className="text-[10px] text-slate-600 mt-1 italic uppercase tracking-tighter">Calculating deltas & frequency</p>
                    </div>
