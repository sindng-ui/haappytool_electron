...
const TopBar: React.FC<{
    ...
    return (
        <div className=" border-b p-4 pr-[200px] flex items-center justify-between shrink-0 h-16 z-50 title-drag relative" style={{ backgroundColor: '#0f172a', borderBottomColor: 'rgba(99, 102, 241, 0.3)' }}>
