...
const TpkExtractor: React.FC = () => {
    ...
    return (
        <div className="flex flex-col h-full bg-slate-50 dark:bg-slate-950 overflow-hidden transition-colors duration-300">
            ...
            <div className="h-16 w-full flex-shrink-0 title-drag z-20 flex items-center gap-3 pl-16 pr-36 border-b border-indigo-500/30 bg-[#0f172a] transition-all duration-200">
