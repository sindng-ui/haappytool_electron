...
export class FilterEngine {
    ...
    check_match(text) {
        ...
        const ret = wasm.filterengine_check_match(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    /**
     ...
     */
    check_match_ptr(len) {
        const ret = wasm.filterengine_check_match_ptr(this.__wbg_ptr, len);
        return ret !== 0;
    }
    /**
     * @returns {number}
     */
    get_buffer_ptr() {
        const ret = wasm.filterengine_get_buffer_ptr(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {boolean} case_sensitive
     */
    constructor(case_sensitive) {
        const ret = wasm.filterengine_new(case_sensitive);
     ...
     */
    reserve_buffer(size) {
        wasm.filterengine_reserve_buffer(this.__wbg_ptr, size);
    }
    /**
     * @param {any} keywords
     */
    update_keywords(keywords) {
        const ret = wasm.filterengine_update_keywords(this.__wbg_ptr, keywords);
        if (ret[1]) {
...
const FilterEngineFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_filterengine_free(ptr >>> 0, 1));
